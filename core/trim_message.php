...
use rmcgirr83\sfpo\core\trim_message_bbcodes;
...
class trim_message
{
	...
	*/
	private function trim()
	{
		...
		if (!$this->bbcode_uid)
		{
			$this->trimmed_message = utf8_substr($this->message, 0, $this->length) . $this->append_str . $this->user_message;
			return true;
		}
	...
	*/
	private function trim_action()
	{
		...
		*/
		...
		$this->bbcodes = new trim_message_bbcodes($this->trimmed_message, $this->bbcode_uid, $this->length);
		...
		*/
		...
		if ($this->bbcodes->is_trimmed)
		{
			...
			$this->trimmed_message .= $this->user_message;
		}
